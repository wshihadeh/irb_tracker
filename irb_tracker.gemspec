...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Track and corrolate IRB activities to users.}
  spec.description   = %q{Track all commands exected in an IRB console and correlate the actions to the users executed them.}
